...
// Kayıt formunda "Şehir" seçildiğinde "İlçe" listesini otomatik doldurmak için kullanılır.
// NOT: İlçe isimleri elden derlenmiştir; resmi/güncel bir kaynakla (ör. TÜİK, NVİ)
// karşılaştırıp gerekirse güncellenmesi önerilir.
...
export const TURKEY_LOCATIONS: CityData[] = [
  ...
  { city: 'Ankara', districts: ['Akyurt', 'Altındağ', 'Ayaş', 'Bala', 'Beypazarı', 'Çamlıdere', 'Çankaya', 'Çubuk', 'Elmadağ', 'Etimesgut', 'Evren', 'Gölbaşı', 'Güdül', 'Haymana', 'Kalecik', 'Kazan', 'Keçiören', 'Kızılcahamam', 'Mamak', 'Nallıhan', 'Polatlı', 'Pursaklar', 'Sincan', 'Şereflikoçhisar', 'Yenimahalle'] },
  ...
  { city: 'Kahramanmaraş', districts: ['Afşin', 'Andırın', 'Çağlayancerit', 'Dulkadiroğlu', 'Ekinözü', 'Elbistan', 'Göksun', 'Onikişubat', 'Pazarcık', 'Türkoğlu'] },
  ...
  { city: 'Kırıkkale', districts: ['Bahşili', 'Balışeyh', 'Çelebi', 'Delice', 'Karakeçili', 'Keskin', 'Merkez', 'Sulakyurt', 'Yahşihan'] },
  ...
  { city: 'Sinop', districts: ['Ayancık', 'Boyabat', 'Dikmen', 'Duraağaç', 'Erfelek', 'Gerze', 'Merkez', 'Saraydüzü', 'Türkeli'] },
  { city: 'Sivas', districts: ['Akıncılar', 'Altınyayla', 'Divriği', 'Doğanşar', 'Gemerek', 'Gölova', 'Hafik', 'İmranlı', 'Kangal', 'Koyulhisar', 'Merkez', 'Suşehri', 'Şarkışla', 'Ulaş', 'Yıldızeli', 'Zara'] },
  ...
  { city: 'Trabzon', districts: ['Akçaabat', 'Araklı', 'Arsin', 'Beşikdüzü', 'Çarşıbaşı', 'Çaykara', 'Dernekpazarı', 'Düzköy', 'Hayrat', 'Köprübaşı', 'Maçka', 'Of', 'Ortahisar', 'Şalpazarı', 'Sürmene', 'Tonya', 'Vakfıkebir', 'Yomra'] },
...
export const TURKEY_CITIES: string[] = TURKEY_LOCATIONS.map((c) => c.city);

export function getDistrictsForCity(city: string): string[] {
  return TURKEY_LOCATIONS.find((c) => c.city === city)?.districts ?? [];
}
