...
export const INITIAL_TRADES: TradeOffer[] = [
  {
    ...
    timeline: [
      ...
      },
      {
        ...
        description: 'Takas başarıyla tamamlandı ve profillere yansıtıldı.',
        timestamp: 'Bekleniyor',
        actorId: 'system',
        actorName: 'Swaloop Sistemi',
        status: 'pending',
...
export const INITIAL_COMMUNITY_POSTS: CommunityPost[] = [
  {
    ...
    content:
      'Depoda tozlanan bisikletimi ihtiyaç duyduğum Canon fotoğraf makinesiyle takasladım. Sıfır para harcamadan yeni bir hobiye başladım. Swaloop topluluğuna teşekkürler!',
    images: [
      'https://images.unsplash.com/photo-1485965120184-e220f721d03e?w=800&auto=format&fit=crop&q=80',
    ],
    tradeStory: {
...
export const INITIAL_NOTIFICATIONS: NotificationItem[] = [
  ...
  },
  {
    ...
    userId: 'user-current',
    type: 'badge',
    title: 'Yeni Rozet Kazandın: Sosyal Takasçı 🎉',
    message: 'Topluluğa bir takas hikayesi paylaştın!',
    linkUrl: '/rozetler',
    isRead: false,
...
export const INITIAL_ADMIN_LOGS: AdminAuditLog[] = [
  ...
  },
  {
    id: 'log-3',
    adminName: 'Admin Kemal S.',
    action: 'Kategori Listesi Güncellendi',
    target: 'Elektronik / Tablet Alt Kategorisi',
    timestamp: '17 Mayıs 2024, 16:30',
    ipAddress: '194.27.12.8',
    details: 'Kategori etiketleri kullanıcı geri bildirimlerine göre revize edildi.',
  },
];
